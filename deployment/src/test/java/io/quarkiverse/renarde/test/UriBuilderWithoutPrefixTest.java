...
public class UriBuilderWithoutPrefixTest {
    ...
    void testDefaultUriBuilderIsUsed() {
        ...
        assertEquals("/endpoint-url", relativePath);
        assertEquals("http://localhost:8081/endpoint-url", absolutePath);
        assertEquals("/endpoint-url?t=param", relativePathWithParam);
        assertEquals("http://localhost:8081/endpoint-url?t=param", absolutePathWithParam);
    }
